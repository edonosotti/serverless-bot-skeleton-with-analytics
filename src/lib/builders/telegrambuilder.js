...
function TelegramBuilder() {
  ...
  this.renderMagicTricks = function() {
    ...
    for (let img of Data.IMAGES) {
      ...
      messages.push(new telegramTemplate.Text(title).get());
      messages.push(new telegramTemplate.Photo(thumbnailUrl).get());
      messages.push(new telegramTemplate.Text(img.URL).get());
    }
...
module.exports = TelegramBuilder;
